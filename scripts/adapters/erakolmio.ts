...
const BASE_URL = 'https://www.erakolmio.com';
...
export const erakolmio: Adapter = {
  name: 'Erakolmio',
  baseUrl: BASE_URL,
  ...
  async delivery(): Promise<DeliveryRule | null> {
    // No public shipping page URL found via footer scan. delivery() returns
    // null; retailers.json keeps its null entry until a real URL is found.
    return null;
  },
};
